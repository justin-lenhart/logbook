...
**Operational value:** MEDIUM for Part 117 purposes directly. TAFB is more relevant for pay computation and efficiency metrics (see the Efficiency dashboard). It is not a Part 117 compliance metric per se, but it is related to overall duty exposure.
